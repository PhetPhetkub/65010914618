...
EXECUTE dbms_output.put_line('Start repository upgrade from 11.2.1.1.1 to 11.2.1.1.2.');
EXECUTE dbms_output.put_line('');
...
EXECUTE dbms_output.put_line('');
EXECUTE dbms_output.put_line('End repository upgrade from 11.2.1.1.1 to 11.2.1.1.2.');
EXECUTE dbms_output.put_line('');
